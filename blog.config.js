...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '825博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的科技爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://100825.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '资源,网络,技术,分享, 博客', // 网站关键词 英文逗号隔开
